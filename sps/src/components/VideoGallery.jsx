...
const VideoGallery = () => {
  return (
    <div className=" reveal w-full flex flex-col justify-around items-center gap-5 bg-green-600 text-white p-5">
      <h2 className="text-3xl font-bold text-center mb-5 uppercase">Video Gallery</h2>
