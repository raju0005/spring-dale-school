...
import { setContact } from '../redux/contactReducerSlice';
...
const ContactForm = () => {
  ...
  const handleSubmit = (event) => {
    ...
    dispatch(setContact({ name, email, message }));
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div>
          ...
          <input
            ...
            className="shadow-sm bg-green-50 border text-green-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5"
